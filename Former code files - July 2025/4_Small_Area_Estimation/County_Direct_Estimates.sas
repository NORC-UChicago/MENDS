...
proc import datafile="P:\A154\Common\PUF_Data\Crosswalks\zip_county_122024_from_hudq42024.xlsx" 
	out=zip_county_122024_from_hudq42024
	dbms=xlsx replace;
	getnames=yes;
...
data county;
	set "P:\A154\Common\PUF_Data\Other\County_FIPS.sas7bdat";
run;

proc sort data = zip_county_122024_from_hudq42024 out = zip_county_HUD0;
	by county;
run;
...
proc export data = estimates
			outfile = "P:\A154\Common\SAE\Q1\Direct Estimates\County_Direct_Estimates.xlsx"
			dbms = excel replace;
run;
