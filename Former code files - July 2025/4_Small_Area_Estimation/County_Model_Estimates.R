...
estimates = read_excel("P:/A154/Common/SAE/Q1/Direct Estimates/County_Direct_Estimates.xlsx",
         sheet="ESTIMATES") 
...
# Covariates
covariates = read_excel("P:/A154/Common/SAE/Covariates/SAE_Covariates.xlsx")  
names(covariates) = toupper(names(covariates)) # Capitalize all column names

# Variable names for direct estimate and covariates
IV = c("PREVALENCE")
variables = c("ACTL_PER_CAP_FFS_COST_21",       
              "STDIZD_PER_CAP_FFS_COST_21",      "STD_ADJ_PER_CAP_FFS_COST_21",    
              "MD_NF_ALL_GP_21",                 "MD_NF_CARD_DIS_21",              
              "HOSP_21",                         "HOSP_ADM_21",                    
              "STGH_ADULT_CARD_SVC_21",          "MEDN_AGE_20",                    
              "FORGN_BORN_POPN_PCT_21",          "URBAN_POPN_PCT_20",              
              "ISCHEMC_HEART_DIS_DETH_3YR_21",   "OTH_CARD_DIS_DETH_3YR_21",       
              "PERS_DEEP_POVTY_PCT_21",                      
              "FOOD_STAMP_RECPNT_SNAP_PCT_20",   "DISBLD_CIV_NONNSTL_18_64_PCT_21",
              "DISBLD_CIV_NONNSTL_GE65_PCT_21",  "PERS_NOINS_18_64_PCT_20",        
              "OWNER_OCCD_HOUS_PCT_20",          "POPN_DENSTY_PER_SQUR_MI_20",     
              "ANNUL_PARTCLT_MATTR_2_5_AVG_19",  "METRO",                          
